...
```{r antal_pat_årsrapport, echo=FALSE}
...
Tabelle=table(Sort$ar)
as.matrix(Tabelle)

par(mfcol=c(1,1))
y=sort(unique(Sort$ar))
plot(y,cumsum(as.matrix(Tabelle)),type="l",xlab="År",ylab="Antal registrerade patienter",lty=c(1,1),lwd=c(3,3),col="dodgerblue2")
# hej joop
```
...
# Hejsan commit pull push Giiiiit fattari ngenting
```
